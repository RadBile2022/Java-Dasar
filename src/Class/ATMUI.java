...
public class ATMUI extends javax.swing.JFrame {
    ...
    public ATMUI() {
        initComponents();
        loginPIN();   // proses login PIN
    }
    
    // METHOD
    public void loginPIN(){
        // Inisialisasi Object
        Nasabah nasabah = new Nasabah("Wahyu Radar");
        Rekening rekening = new Rekening(500000);
        nasabah.setRekening(rekening);
        nasabahAktif = nasabah;
        
        // Display setelah PIN valid
        nasabahAktif = nasabah;
        rekeningAktif = nasabahAktif.getRekening();
    ...
    private void jButtonHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonHapusActionPerformed
        ...
        String angka = jInputJumlah.getText();
        String hasil = angka.substring(0,(jInputJumlah.getText()).length()-1);
    ...
    private void jButtonTarikActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTarikActionPerformed
        // TODO add your handling code here:
        double jumlah = Double.parseDouble(jInputJumlah.getText());
        rekeningAktif.tarik(jumlah);
        display.append("\nTarik Sebesar : " + jumlah);
    ...
    private void jButtonSaldoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaldoActionPerformed
        // TODO add your handling code here:
        display.append("\nSaldo anda sebesar : " + rekeningAktif.getSaldo());
